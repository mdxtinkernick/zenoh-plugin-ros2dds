...
zenoh::kedefine!(
    ...
    pub(crate) ke_liveliness_pub: "@ros2_lv/${plugin_id:*}/MP/${ke:*}/${namespace:*}/${node_name:*}/${typ:*}/${qos_ke:*}",
    pub(crate) ke_liveliness_sub: "@ros2_lv/${plugin_id:*}/MS/${ke:*}/${namespace:*}/${node_name:*}/${typ:*}/${qos_ke:*}",
    pub(crate) ke_liveliness_service_srv: "@ros2_lv/${plugin_id:*}/SS/${ke:*}/${namespace:*}/${node_name:*}/${typ:*}",
    pub(crate) ke_liveliness_service_cli: "@ros2_lv/${plugin_id:*}/SC/${ke:*}/${namespace:*}/${node_name:*}/${typ:*}",
    pub(crate) ke_liveliness_action_srv: "@ros2_lv/${plugin_id:*}/AS/${ke:*}/${namespace:*}/${node_name:*}/${typ:*}",
    pub(crate) ke_liveliness_action_cli: "@ros2_lv/${plugin_id:*}/AC/${ke:*}/${namespace:*}/${node_name:*}/${typ:*}",
);
